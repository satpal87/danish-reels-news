      ...
      <div className="prose prose-lg dark:prose-invert max-w-none mb-10">
        {article.html ? (
          ...
          <>
            ...
            <p className="leading-relaxed">
              The AI-generated content aims to provide accurate and timely information on relevant
              topics while maintaining journalistic standards and ethical considerations.
            </p>
          </>
        )}
      </div>
